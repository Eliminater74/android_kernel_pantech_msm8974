...
#if (1) // F_PANTECH_CAMERA_QBUG EF65S CASE#01574464(msm.git.patch), CASE#01580358
/* the error happened by Invalid deblocking filter mode
<7>[286551.174279 / 06-01 23:46:07.127]-CPU:0 [ kworker/u:3: 4551] msm_vidc: 1: SFR Message from FW : Err_Fatal - Z:\b\venus\encoders\src\venus_venc_host_driver.c:4247: 
*/
...
#if (0) // F_PANTECH_CAMERA_QBUG EF65S CASE#01574464(msm.git.patch), CASE#01580358
	case V4L2_CID_MPEG_VIDEO_H264_LOOP_FILTER_MODE:
		property_id =
